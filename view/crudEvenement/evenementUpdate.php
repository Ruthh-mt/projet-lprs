    ...
    <form action="../../src/treatment/traitementUpdateEvenement.php" method="post">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Type d'evenement : <input type="text" class="form-control" id="type_eve" name="type_eve" value="<?php echo $evenement->getTypeEvenement(); ?>"></p>
                <p class="card-text">Lieu de l'evenement : <input type="text"  class="form-control" id="lieu_eve" name="lieu_eve"  value="<?php echo $evenement->getLieuEvenement(); ?>"></p>
