        ...
        <div class="section-offre">
            ...
            toastr.' . $type . '("' . $message . '");
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="titre_post" name="titre_post"
                               placeholder="Entrez le titre du Post">
                    </div>
                    <div class="mb-3">
                        <label for="contenu_post">Contenue du Post</label>
                        <textarea class="form-control" type="text" id="contenu_post" name="contenu_post"
                                  placeholder="Entrez le contenue du Post"></textarea>
                    </div>
                    <!--
