...
<nav class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom text-white bg-dark">
    <div class="nav col mb-2 justify-content-center mb-md-0">
        <div class="btn-group mx-1" role="group" aria-label="Basic example">
            <a href="p" class="btn btn-outline-info active">Alumni</a>
            <a href="../public/crudPostuler/candidatureRead.php" class="btn btn-outline-danger">Candidature</a>
            <a href="../public/crudEntreprise/entrepriseRead.php" class="btn btn-outline-info">Entreprise</a>
            <a href="../public/crudEtudiant/etudiantRead.php" class="btn btn-outline-info">Étudiant</a>
            <a href="../public/crudEvenement/evenementRead.php" class="btn btn-outline-danger">Évènement</a>
            <a href="../public/crudFormation/formationRead.php" class="btn btn-outline-info">Formation</a>
            <a href="../public/crudGestionnaire/gestionnaireRead.php" class="btn btn-outline-info">Gestionnaire</a>
            <a href="../public/crudOffre/offreRead.php" class="btn btn-outline-info">Offre</a>
            <a href="../public/crudPartenaire/partenaireRead.php" class="btn btn-outline-info">Partenaire</a>
            <a href="../../crudPost/postRead.php" class="btn btn-outline-danger">Post</a>
            <a href="../public/crudProfesseur/professeurRead.php" class="btn btn-outline-info">Professeur</a>
            <a href="../public/crudReponse/reponseRead.php" class="btn btn-outline-info">Réponses</a>
            <a href="../public/crudUtilisateur/utilisateurRead.php" class="btn btn-outline-info">Utilisateur</a>
        </div>
    </div>
</nav>
