...
require_once '../../src/modele/UserModel.php';
require_once '../../src/repository/utilisateurRepository.php';

$id = isset($_GET['id']) ? (int)$_GET['id'] : null;
if (!$id) { die("L'utilisateur est introuvable."); }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
     ...
     $utilisateurRepo->update($id, $dataArr);
     header('Location: utilisateurRead.php?id=' . $id);
     exit;
}
?>
     <!doctype html>
