...
class PostRepository
{
    ...
    public function UpdatePost($post){
        $ajout="UPDATE post SET titre_post=:titrePost,canal=:canal,contenu_post=:contenuPost,date_heure_post=:dateHeurePost,ref_user=:refUser 
    ...
    public function getAllPostByCanal($post){
        $sql="SELECT * FROM post WHERE canal=:canal";
        $stmt=$this->db->connexion()->prepare($sql);
